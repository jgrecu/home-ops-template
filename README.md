...
| **Media** | Jellyfin, Immich, Kavita, Radarr, Sonarr, Bazarr, Transmission, Autobrr, Jackett, Flaresolverr, Overseerr, Recyclarr |
| **Cloud** | Nextcloud |
| **Dev** | Forgejo + Actions runners, Homepage |
...
| `task tidy` | Archive template scaffolding after cluster is live |
...
│   ├── storage/          # storage:bootstrap-garage, storage:restore-pvc
